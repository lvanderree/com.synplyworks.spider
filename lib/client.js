...
exports.Client = exports.ENERGY_MONITORING_URL = exports.POWER_PLUGS_URL = exports.ENERGY_DEVICES_URL = exports.DEVICES_URL = exports.AUTHENTICATE_URL = exports.BASE_URL = void 0;
...
exports.BASE_URL = 'https://spider-api.ithodaalderop.nl';
exports.AUTHENTICATE_URL = exports.BASE_URL + '/api/tokens';
exports.DEVICES_URL = exports.BASE_URL + '/api/devices';
exports.ENERGY_DEVICES_URL = exports.BASE_URL + '/api/devices/energy/energyDevices';
exports.POWER_PLUGS_URL = exports.BASE_URL + '/api/devices/energy/smartPlugs';
exports.ENERGY_MONITORING_URL = exports.BASE_URL + '/api/monitoring/15/devices';
var headers = {
...
var Client = /** @class */ (function () {
    function Client(username, password) {
        ...
        this.convertToHex = function (str) {
            var hex = '';
    ...
    Client.prototype.getDevices = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        deviceHeaders["Content-Type"] = 'application/json';
                        url = exports.DEVICES_URL + "/" + device.id;
                        return [4 /*yield*/, node_fetch_1.default(url, {
                                method: 'PUT',
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, node_fetch_1.default(exports.AUTHENTICATE_URL, {
                                method: 'POST',
                                body: form,
                                headers: headers,
                            })];
