...
const Client = /** @class */ (function() {
  ...
  Client.prototype.getDevices = function() {
    return __awaiter(this, void 0, void 0, function() {
      let deviceHeaders; let response; let _a; let _b; let _c; let _d; let _e; let
        devices;
      return __generator(this, function(_f) {
        switch (_f.label) {
          ...
          case 1:
            ...
            _f.label = 2;
          case 2:
            deviceHeaders = { authorization: `Bearer ${this.auth.access_token}`, ...headers };
  ...
  Client.prototype.updateDevice = function(device) {
    return __awaiter(this, void 0, void 0, function() {
      let deviceHeaders; let url; let response; let _a; let _b; let _c; let _d; let
        _e;
      return __generator(this, function(_f) {
        switch (_f.label) {
          case 0:
  ...
  Client.prototype.login = function() {
    return __awaiter(this, void 0, void 0, function() {
      let form; let response; let _a; let _b; let _c; let _d; let _e; let
        auth;
      return __generator(this, function(_f) {
        switch (_f.label) {
          case 0:
