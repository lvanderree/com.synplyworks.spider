...
const ClientManager = /** @class */ (function() {
  function ClientManager(client) {
    this.devices = undefined;
    this.client = client;
  }
  ClientManager.prototype.getDevices = function(url) {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            _a = this;
            return [4 /* yield */, this.client.getDevices(url)];
          case 1:
            _a.devices = _b.sent();
        ...
        if (devices instanceof Array) {
          const thermostats = devices.filter(d => {
            return (d.type = 105)
                        ...
                        && d.properties.find(p => {
                          return p.id == 'SetpointTemperature';
                        });
          });
          return thermostats;
        }
      ...
      .then(devices => {
        if (devices instanceof Array) {
          return devices.find(d => {
            return (d.type = 105)
                        && (d.manufacturer == 'spider')
            //                        && d.properties.find(function (p) { return p.id == 'SetpointTemperature'; })
                        && d.properties.find(p => {
                          return p.id == 'FanSpeed';
                        });
          });
        }
        return null;
  ...
  ClientManager.prototype.getEnergyDevices = function() {
    return this.getDevices(client_1.DEVICES_URL)
      .then(energyDevices => {
  ...
  ClientManager.prototype.getCentralMeters = function() {
  ...
  ClientManager.prototype.setFanSpeed = function(device, speed) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            FanSpeed = device.properties.find(p => {
              return p.id === 'FanSpeed';
            });
            if (!FanSpeed) {
  ...
  ClientManager.prototype.setTargetTemperature = function(device, temperature) {
    return __awaiter(this, void 0, void 0, function() {
      let SetpointTemperature; let
        response;
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            SetpointTemperature = device.properties.find(p => {
              return p.id === 'SetpointTemperature';
            });
  ...
  ClientManager.prototype.setOperationMode = function(device, mode) {
    return __awaiter(this, void 0, void 0, function() {
      let OperationMode; let
        response;
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            OperationMode = device.properties.find(p => {
              return p.id === 'OperationMode';
            });
            if (!OperationMode) {
  ...
  ClientManager.prototype.setOverrideMode = function(device, mode) {
    return __awaiter(this, void 0, void 0, function() {
      let OverrideMode; let
        response;
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            OverrideMode = device.properties.find(p => {
              return p.id === 'OverrideMode';
            });
            if (!OverrideMode) {
